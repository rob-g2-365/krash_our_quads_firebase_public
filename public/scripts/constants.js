...
export const VISTA_RECORD = {
  ...
  notes: 'Please use 25Mbs data throughput. ' + 
    'Channel 3 is removed because of the potential for bleeding into other ' + 
    'analog channels. Channel 8 is the public/configuration channel, so it ' + 
    'is not used. ',
  freqMap: [
...
export const DJI_RECORD = {
  ...
  notes: 'Please use 25Mbs data throughput. ' +
    'Channel 1 and Channel 2 are removed because they bleed into other analog ' + 
    'channels. Channel 5 is the public/configuration channel for DJI and ' +
    'Walksnail so it is removed also.',
  freqMap: [
...
export const HDZERO_RECORD = {
  ...
  notes: 'Please configure your HDZero goggles to use FCC mode, Low Band, with ' +
